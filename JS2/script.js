...
function passRating(device1, device2) {
    return parseInt(device1.ratingRevievs) - parseInt(device2.ratingRevievs);
}

function passPrice(device1, device2) {
    return extractNumberFromPrice(device1) - extractNumberFromPrice(device2);
}

function extractNumberFromPrice(device) {
    let value = device.price;
...
function sortDevices(array, value, direction) {
    if (value === "price") {
        switch (direction) {
            case "up":
                array = array.sort(passPrice);
                break;
            case "down":
                array = array.sort(passPrice).reverse();
                break;
            default:
                array = array.sort(passPrice);
        }
        ...
        switch (direction) {
            case "up":
                array = array.sort(passRating);
                break;
            case "down":
                array = array.sort(passRating).reverse();
                break;
            default:
                array = array.sort(passRating);
        }
 ...
 //to sort by price replace "rating" to "price"
// to change sort direction replace "up" to "down"
sortDevices(arr, "rating", "up");
